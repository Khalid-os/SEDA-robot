...
/*void mover_motores(in1,in2,in3,in4) //Dando valores a las 4 vbles muevo los motores
{
		LPC_GPIO1 -> FIOPIN = (in1<<0);
	  LPC_GPIO1 -> FIOPIN = (in2<<1);
	  LPC_GPIO1 -> FIOPIN = (in3<<4);
	  LPC_GPIO1 -> FIOPIN = (in4<<8);
}*/
